...
export const APP_TITLE = "Laptop Inventory Pro";
...
export const ICONS: { [key in Tab]?: React.ReactNode } = { // Made ICONS potentially partial as Analysis is removed
  [Tab.Dashboard]: (
...
export const LAPTOP_BRANDS = ["Apple", "Dell", "HP", "Lenovo", "Asus", "Acer", "Microsoft", "Samsung", "MSI", "Razer", "LG", "Other"];
export const RAM_OPTIONS = [4, 8, 12, 16, 24, 32, 64]; // in GB
export const STORAGE_TYPES = ["SSD", "HDD"];
export const STORAGE_SIZES = [128, 256, 512, 1000, 2000]; // in GB, 1000 for 1TB etc.
